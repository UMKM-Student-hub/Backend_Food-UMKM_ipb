from sqlalchemy import Integer, Text, DateTime, ForeignKey, SmallInteger, CheckConstraint, UniqueConstraint
...
class ReviewORM(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint('order_id', 'menu_item_id', name='unique_review_per_order_item'),
    )