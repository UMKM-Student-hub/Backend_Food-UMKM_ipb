...
class OrderRepositoryImpl(IOrderRepository):
    ...
    def _to_domain(self, orm: OrderORM) -> Order:
        """Fungsi krusial untuk memetakan ORM Database ke Objek Domain."""
        domain_items = []
    ...
    async def find_by_id(self, order_id: int) -> Optional[Order]:
        """Implementasi pencarian detail pesanan (Mengatasi error 404)."""
    ...
    async def find_by_buyer(self, buyer_id: int) -> List[Order]:
        """Mengambil pesanan pembeli (Mengatasi error 500 AttributeError)."""
